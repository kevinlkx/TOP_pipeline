...
model_coef_file        <- '/datacommons/harteminklab/kl124/TOP/output/TOP_postfit/hg19/OpenChromDnase/JASPARver1/priorVar1/M5/TOP_posterior_mean_coef.rds'
data_dir               <- '/hpc/home/kl124/work/TOP/processed_data_202112/atac_sites_counts/hg19/JASPAR2022/'
thresh_pValue          <- '1e-5'
bin_method             <- 'M5'
sites_dir              <- '/hpc/home/kl124/work/TOP/processed_data_202112/candidate_sites/hg19/JASPAR2022/'
genomecount_dir        <- '/hpc/home/kl124/work/TOP/processed_data_202112/atac_genome_counts/hg19/'
ref_size               <- '1e8'
idxstats_dir           <- '/hpc/home/kl124/work/data/ENCODE/ATAC-seq/hg19/'
outdir                 <- '/hpc/home/kl124/work/TOP/TOP_predictions_202112/hg19/DukeDNase/JASPAR2022/predicted_occupancy'
...
for( i in 1:nrow(metadata)) {
  ...
  if(length(sample_ids) == 1){
    ...
    if(file.exists(data_file) && file.size(data_file) > 0){
      ...
      outfile <- paste0(tf_name, '_', pwm_id, '_', thresh_pValue, '.', cell_type, '.', model_level, '.level.predicted.occupancy.txt.gz')
